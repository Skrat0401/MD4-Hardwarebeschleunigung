...
int main() {
  ...
  double runningTime1 = ((double)(end - start) / CLOCKS_PER_SEC);
  printf("elapsed time for program : %f seconds.\n", runningTime1);
  printf("start :                    %ld clock cycles.\nend   :                    %ld clock cycles.\n%ld runs with %d bit\n\nCPU Run 2 : \n", start, end, counter, len * 32);
  //--------------------------------------------------------------------------------------------------- 1024 BIT
  counter = 0;
  ...
  double runningTime2 = ((double)(end - start) / CLOCKS_PER_SEC);
  printf("elapsed time for program : %f seconds.\n", runningTime2);
  printf("start :                    %ld clock cycles.\nend   :                    %ld clock cycles.\n%ld runs with %d bit\n\nCPU Run 3 : \n", start, end, counter, len * 32);
  //--------------------------------------------------------------------------------------------------- 1536 BIT
  counter = 0;
  ...
  double runningTime3 = ((double)(end - start) / CLOCKS_PER_SEC);
  printf("elapsed time for program : %f seconds.\n", runningTime3);
  printf("start :                    %ld clock cycles.\nend   :                    %ld clock cycles.\n%ld runs with %d bit\n\nCPU Hashes: \n", start, end, counter, len * 32);
  //---------------------------------------------------------------------------------------------------
  ...
  hash = MD4Digest(arr, 48);
  printf("uint32_t hash (hex) 1536 bit: %x , %x, %x, %x\n\n", hash[3], hash[2], hash[1], hash[0]);
};
